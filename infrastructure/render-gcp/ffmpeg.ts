...
import { SoundEvent, SoundDesignSettings } from './soundDesignCompiler';
...
export function buildFilterComplex(
  ...
  soundSettings?: SoundDesignSettings,
  assetIdToInputIndex?: Record<string, number>,
  ...
  if (!isSoundDesignActive || activeEvents.length === 0 || !assetIdToInputIndex) {
    ...
    const musicDuckingIntervals: string[] = [...duckingIntervals];
