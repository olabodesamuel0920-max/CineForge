...
app.post('/render', async (req, res) => {
    ...
    (async () => {
        try {
            ...
            const totalDuration = conformedTimeline.reduce((acc, block) => acc + (block.end - block.start) / block.speed, 0);
...
app.post('/render/preview', async (req, res) => {
    ...
    try {
        ...
        const ffmpegCmd = getFfmpegCommand();
        const runResult = (0, child_process_1.spawnSync)(ffmpegCmd, ffmpegArgs);
